function calAnswer(){
    var exp = document.getElementById("id1").value;var res = eval(exp); document.getElementById("output").innerHTML= res+'.';
    }
    function clearAll(){ document.getElementById("id1").value
    ...
    function	printName(){ document.getElementById("id1").value
    = ""; document.getElementById("output").innerHTML = "MHITS";setTimeout(offCalc, 1000);
